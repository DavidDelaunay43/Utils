...
class AppFinder:
    ...
    def __init__(self, write_json: str | Path = None) -> dict:
    ...
    def write_json_file(self, json_file: str):
        self.dict_to_json(dictionary=self.app_dict, json_file_path=json_file)
        
        
    def dict_to_json(self, dictionary: dict, json_file_path: str | Path) -> None:
